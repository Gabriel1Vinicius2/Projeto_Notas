...
export function NewNoteCard({ onNoteCreated}: NewNoteCardProps){
    ...
    return (
        <Dialog.Root>
            <Dialog.Trigger className='rounded-md flex flex-col bg-slate-700 p-5 text-left space-y-3 hover:ring-2 hover:ring-slate-600 focus:ring-lime-400'>
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className='fixed overflow-hidden inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] w-full md:h-[68vh] bg-slate-700 md:rounded-md flex flex-col outline-none'>
                    ...
                    <form className='flex-1 flex flex-col'>
                        ...
                        {isRecording ? (
                            <button 
                                ...
                                className='w-full flex items-center justify-center gap-2 bg-slate-900 py-4 text-center text-sm text-slate-300 outline-none font-medium group hover:bg-slate-100'
                            >
